<?php
//定数
const ROOT_URL = 'http://localhost/kagoyume/app/top.php';     //indexディレクトリへのURL
const TOP_URI = '/';                                //トップページ
const ITEM = 'item.php';                        //商品ページ
const REGISTRATION = 'registration.php';        //登録確認ページ
const REGISTRATION_CONFIRM= 'registration_confirm.php'; //登録完了ページ
